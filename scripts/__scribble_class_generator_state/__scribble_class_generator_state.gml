//PADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPADDINGPA
function __scribble_class_generator_state() constructor
{
    __glyph_grid     = ds_grid_create(1000, __SCRIBBLE_GEN_GLYPH.__SIZE);
    __control_grid   = ds_grid_create(1000, __SCRIBBLE_GEN_CONTROL.__SIZE); 
    ...
    __temp_grid      = ds_grid_create(1000, __SCRIBBLE_GEN_WORD.__SIZE); 
