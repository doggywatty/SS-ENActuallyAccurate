if (ds_list_find_index(global.SaveRoom, id) == -1)
{
	...
	create_particle(xorigin + (sprite_width / 2), yorigin + (sprite_height / 2), spr_enemypuncheffect);
	create_particle(xorigin + (sprite_width / 2), yorigin + (sprite_height / 2), (object_index == obj_chocofrogsmall) ? spr_smallpoof : spr_poofeffect);
