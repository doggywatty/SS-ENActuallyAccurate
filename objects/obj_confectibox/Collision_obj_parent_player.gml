...
{
	create_particle(xorigin + (sprite_width / 2), yorigin + (sprite_height / 2), spr_taunteffect).particle_depth(_content.depth + 1);
	...
	create_small_number(xorigin + (sprite_width / 2), yorigin + (sprite_height / 2), 1000);
	global.ComboTime = 60;
}
