...
if (place_meeting(x, y, obj_parent_player) && obj_parent_player.state != states.stunned && sprite_index == openSpr && global.panic == 0 && obj_parent_player.sprite_index != obj_parent_player.spr_lookdoor && sprite_index != closedspr)
{
	...
	obj_parent_player.state = states.stunned;
